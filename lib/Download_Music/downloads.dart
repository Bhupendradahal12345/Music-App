...
import 'package:shrayesh_patro/Download_Music/playlist_head.dart';

import '../API/shrayesh_patro.dart';
import '../Backup/gradient_containers.dart';
import '../Backup/picker.dart';
import '../Backup/seek_bar.dart';
import '../Extra/downbar.dart';
import '../main.dart';

import '../screens/local_playlist.dart';
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              song['isOffline'] = widget.songs == widget.songs;
              return ListTile(
                leading: imageCard(
                  ...
                  children: [
                    PopupMenuButton(
                      ...
                      onSelected: (int? value) async {
                        ...
                        if (value == 2) {
                          showAddToPlaylistDialog(context,  widget.songs[index] as Map);
                        };
                      },
                    ),
                  ],
